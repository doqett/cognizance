...
export const footerItems = {
  ...
  legal: [
    ...
    { path: '/terms', name: 'Terms of Service', internal: true, new: false  },
    { path: '/cookies', name: 'Cookies Policy', internal: true, new: false  },
    { path: '/support', name: 'Help Center', internal: true, new: false  },
    { path: '/blog', name: 'Blog', internal: true, new: true  },
    { path: '/forums', name: 'Communities', internal: true, new: true  },
