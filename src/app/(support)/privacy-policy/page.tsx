      ...
      <div className='prose max-w-none text-base prose-p:my-2 prose-h2:my-6 break-words dark:prose-invert prose-a:text-blue-700 prose-a:no-underline hover:prose-a:text-blue-500 dark:prose-a:text-blue-300 dark:hover:prose-a:text-blue-500'>
        ...
        <article>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Doqett, the software program provided by the
                Company.
              </p>
            </li>
            <li>
              <p>
                ...
                Doqett Labs Pvt. Ltd., Kathmandu, Nepal.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Doqett, accessible from{' '}
                <a href='https://www.doqett.com/' rel='external nofollow noopener' target='_blank'>
                  https://www.doqett.com/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: support@doqett.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{' '}
                <a
                  href='https://doqett.com/support'
                  rel='external nofollow noopener'
                  target='_blank'
                >
                  https://doqett.com/support
                </a>
              </p>
            </li>
          </ul>
